...
urlpatterns = [
    ...
    path('testruns/<int:tr_id>/toggle_public/',
         views.TogglePublic.as_view(),
         name='testrun_togglepublic'),
    ...
    path('tarballs/row/<int:offset>/',
         views.TarballRow.as_view(),
         name='Tarball-row'),
    path('status/',
         views.CIStatusView.as_view(), name='ci-status-page'),
